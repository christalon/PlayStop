...
class __TwigTemplate_c6947a310660c5fdb1b0f9df89d626aa8f381cf5e79868e2e9a6d677eb1b2166 extends Twig_Template
{
            ...
            <div class=\"form-group row\">
              <div class=\"input-group\">
                <div class=\"input-group-btn dropdown\">
                  <button type=\"button\" id=\"button-path\" data-toggle=\"dropdown\" class=\"btn btn-light\">";
        // line 25
...
/*               <div class="input-group">*/
/*                 <div class="input-group-btn dropdown">*/
/*                   <button type="button" id="button-path" data-toggle="dropdown" class="btn btn-light">{{ document_root }} <span class="caret"></span></button>*/
/*                   <ul class="dropdown-menu">*/
/*                     {% for path in paths %}*/
