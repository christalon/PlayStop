...
class __TwigTemplate_573675c8e0c4c6189f54550d536b4666059c94dfb6adf0e42a9d8ea807403c83 extends Twig_Template
{
  ...
  <div class=\"row\">";
    ...
    ";
      ...
      <div class=\"row\"> ";
        ...
        // line 275
        echo (isset($context["text_loading"]) ? $context["text_loading"] : null);
        echo "\" data-cart=\"add\" data-option=\"add\" class=\"btn btn-primary btn-lg btn-block\">";
...
\t\$.ajax({
\t\turl: 'index.php?route=product/product/getRecurringDescription&language=' + getCookie('language'),
\t\ttype: 'post',
...
\t\t\t\$.ajax({
\t\t\t\turl: 'index.php?route=tool/upload&language=' + getCookie('language'),
\t\t\t\ttype: 'post',
\t\t\t\tdataType: 'json',
...
\$('#review').load('index.php?route=product/product/review&language=' + getCookie('language') + '&product_id=";
        // line 489
        echo (isset($context["product_id"]) ? $context["product_id"] : null);
        echo "');
...
\t\$.ajax({
\t\turl: 'index.php?route=product/product/write&language=' + getCookie('language') + '&product_id=";
        // line 493
        echo (isset($context["product_id"]) ? $context["product_id"] : null);
        echo "',
\t\ttype: 'post',
...
/*                     <label class="control-label" for="input-option{{ option.product_option_id }}">{{ option.name }}</label>*/
/*                     <div class="input-group time">*/
/*                       <input type="text" name="option[{{ option.product_option_id }}]" value="{{ option.value }}" data-date-format="HH:mm" data-locale="{{ datepicker }}" id="input-option{{ option.product_option_id }}" class="form-control"/>*/
/*                       <div class="input-group-btn">*/
/*                         <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>*/
/*                       </div>*/
/*                     </div>*/
...
/*               <br/>*/
/*               <button type="button" id="button-cart" data-loading-text="{{ text_loading }}" data-cart="add" data-option="add" class="btn btn-primary btn-lg btn-block">{{ button_cart }}</button>*/
/*             </div>*/
/*             {% if minimum > 1 %}*/
...
/* });*/
/* */
/* $('#review').load('index.php?route=product/product/review&language=' + getCookie('language') + '&product_id={{ product_id }}');*/
/* */
/* $('#button-review').on('click', function() {*/
/* 	$.ajax({*/
/* 		url: 'index.php?route=product/product/write&language=' + getCookie('language') + '&product_id={{ product_id }}',*/
/* 		type: 'post',*/
/* 		dataType: 'json',*/
/* 		data: $('#form-review').serialize(),*/
/* 		beforeSend: function() {*/
