...
/* common/header.twig */
class __TwigTemplate_465695fe586a8adfedf163497203b25c51c59fe624b4f26a18090e67b5299827 extends Twig_Template
{
      ...
      ";
        ...
        if ((isset($context["logged"]) ? $context["logged"] : null)) {
          ...
          <li class=\"nav-item dropdown\">
            ...
            echo "\" id=\"user-profile\" class=\"img-circle\"/>&nbsp;&nbsp;<span class=\"d-none d-sm-inline-block\">";
            echo (isset($context["firstname"]) ? $context["firstname"] : null);
            echo " ";
            echo (isset($context["lastname"]) ? $context["lastname"] : null);
            echo "</span></a>
...
/*         <ul class="navbar-nav">*/
/*           <li class="nav-item dropdown">*/
/*             <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle"><img src="{{ image }}" alt="{{ firstname }} {{ lastname }}" title="{{ username }}" id="user-profile" class="img-circle"/>&nbsp;&nbsp;<span class="d-none d-sm-inline-block">{{ firstname }} {{ lastname }}</span></a>*/
/*             <div class="dropdown-menu dropdown-menu-right">*/
